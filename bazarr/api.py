...
api.add_resource(MovieHistory, '/movie/history')
api.add_resource(MovieTools, '/movie/tools')

api.add_resource(HistorySeries, '/series/history')
api.add_resource(HistoryMovies, '/movies/history')
api.add_resource(HistoryStats, '/history')
