...
class MoviesBlacklist(Resource):
    ...
    def get(self):
        ...
        data = (
            ...
            .join(
                TableMovies, on=(TableBlacklistMovie.radarr_id == TableMovies.radarrId)
            )
    ...
    def post(self):
        ...
        blacklist_log_movie(
            radarr_id=radarr_id, provider=provider, subs_id=subs_id, language=language
        )
        delete_subtitles(
            media_type="movie",
            language=language,
