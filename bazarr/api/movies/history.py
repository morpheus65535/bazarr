    ...
    def get(self):
        ...
        if settings.general.getboolean("upgrade_subs"):
            ...
            upgradable_movies = (
                ...
                .join(
                    TableMovies, on=(TableHistoryMovie.radarrId == TableMovies.radarrId)
                )
        ...
        for item in movie_history:
            ...
            if {
                ...
                if os.path.exists(
                    path_mappings.path_replace_movie(item["subtitles_path"])
                ) and os.path.exists(
                    path_mappings.path_replace_movie(item["video_path"])
                ):
