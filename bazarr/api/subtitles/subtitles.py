...
class Subtitles(Resource):
    ...
    def patch(self):
        ...
        if media_type == "episode":
            ...
            metadata = (
                TableEpisodes.select(TableEpisodes.path, TableEpisodes.sonarrSeriesId)
        ...
        if action == "sync":
            ...
            if media_type == "episode":
                store_subtitles(
                    path_mappings.path_replace_reverse(video_path), video_path
                )
            else:
            ...
            use_original_format = request.form.get("original_format") == "true"
            subtitles_apply_mods(
                language, subtitles_path, [action], use_original_format
            )
