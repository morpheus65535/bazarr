...
from bazarr.database import TableHistory, TableHistoryMovie, TableSettingsLanguages
from bazarr.get_languages import alpha2_from_alpha3, language_from_alpha2
