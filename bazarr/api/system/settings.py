...
class SystemSettings(Resource):
    ...
    def get(self):
        ...
        notifications = (
            TableSettingsNotifier.select().order_by(TableSettingsNotifier.name).dicts()
        )
    ...
    def post(self):
        ...
        if languages_profiles := request.form.get("languages-profiles"):
                    ...
                    TableLanguagesProfiles.update(
                        {
                            ...
                            TableLanguagesProfiles.mustNotContain: item[
                                "mustNotContain"
                            ],
                            TableLanguagesProfiles.originalFormat: item[
                                "originalFormat"
                            ]
