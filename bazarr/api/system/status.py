...
class SystemStatus(Resource):
    ...
    def get(self):
        ...
        system_status.update({'database_engine': os.environ['BAZARR_DB_ENGINE_VERSION']})
        system_status.update({'database_migration': os.environ['BAZARR_DB_MIGRATION_VERSION']})
