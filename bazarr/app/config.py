...
validators = [
    ...
    # opensubtitlesorg section
    Validator('opensubtitlesorg.verify_ssl', must_exist=True, default=True, is_type_of=bool),
    Validator('opensubtitlesorg.user_agent', must_exist=True, default='', is_type_of=str),
