...
defaults = {
    ...
    "legendasdivx": {"username": "", "password": "", "skip_wrong_fps": "False"},
    ...
    "titulky": {"username": "", "password": "", "approved_only": "False"},
    "embeddedsubtitles": {
        "include_ass": "True",
        "include_srt": "True",
        "hi_fallback": "False",
...
ignore_keys = ["flask_secret_key", "page_size", "page_size_manual_search"]
...
def save_settings(settings_items):
    ...
    for key, value in settings_items:
        ...
        if (
            key == "settings-auth-password"
            and value != settings.auth.password
        ...
        if (
            key == "settings-addic7ed-username"
            and key != settings.addic7ed.username
            or key != "settings-addic7ed-username"
            and key == "settings-addic7ed-password"
            and key != settings.addic7ed.password
        ):
            region.delete("addic7ed_data")
        if (
            key == "settings-legendasdivx-username"
            and key != settings.legendasdivx.username
            or key != "settings-legendasdivx-username"
            and key == "settings-legendasdivx-password"
            and key != settings.legendasdivx.password
        ):
            region.delete("legendasdivx_cookies2")
        if (
            key == "settings-opensubtitles-username"
            and key != settings.opensubtitles.username
            or key != "settings-opensubtitles-username"
            and key == "settings-opensubtitles-password"
            and key != settings.opensubtitles.password
        ):
            region.delete("os_token")
        if (
            key == "settings-opensubtitlescom-username"
            and key != settings.opensubtitlescom.username
            or key != "settings-opensubtitlescom-username"
            and key == "settings-opensubtitlescom-password"
            and key != settings.opensubtitlescom.password
        ):
            region.delete("oscom_token")
        if (
            key == "settings-subscene-username"
            and key != settings.subscene.username
            or key != "settings-subscene-username"
            and key == "settings-subscene-password"
            and key != settings.subscene.password
        ):
            region.delete("subscene_cookies2")
        if (
            key == "settings-titlovi-username"
            and key != settings.titlovi.username
            or key != "settings-titlovi-username"
            and key == "settings-titlovi-password"
            and key != settings.titlovi.password
        ):
