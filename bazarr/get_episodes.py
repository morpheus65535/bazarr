...
def sync_episodes():
    notifications.write('Episodes sync from Sonarr started...')
    ...
    for seriesId in seriesIdList:
        notifications.write('Getting episodes data for this show: ' + seriesId[1])
    ...
    notifications.write('Episodes sync from Sonarr ended.')
