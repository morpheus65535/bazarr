...
export const SYSTEM_UPDATE_SYSTEM_STATUS = "UPDATE_SYSTEM_STATUS";
export const SYSTEM_UPDATE_SYSTEM_TASKS = "UPDATE_SYSTEM_TASKS";
export const SYSTEM_UPDATE_SYSTEM_LOGS = "UPDATE_SYSTEM_LOGS";
export const SYSTEM_UPDATE_SYSTEM_SETTINGS = "UPDATE_SYSTEM_SETTINGS";
