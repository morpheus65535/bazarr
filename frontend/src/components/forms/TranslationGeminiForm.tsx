    ...
    >
      <Stack>
        <Alert variant="outline">
          Translate subtitles with Gemini AI using your API key (add it in
          settings).
        </Alert>
...
export const TranslationGeminiModal = withModal(
  TranslationForm,
  "translation-gemini-tool",
  {
    title: "Translate Subtitles with Gemini",
  },
);
