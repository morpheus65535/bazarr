...
export type NewBaseTableProps<T extends object> = {
  instance: TableInstance<T>;
  tableStyles?: NewTableStyleProps<T>;
};

export interface NewTableStyleProps<T extends object> {
  emptyText?: string;
  striped?: boolean;
  placeholder?: number;
  hideHeader?: boolean;
...
export default function NewBaseTable<T extends object>(
  props: NewBaseTableProps<T>,
) {
