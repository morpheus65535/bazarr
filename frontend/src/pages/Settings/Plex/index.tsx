...
import { Check, CollapseBox, Layout, Message, Number,Section, Text } from "@/pages/Settings/components";
    ...
    <Layout name="Interface">
      ...
      <CollapseBox settingKey={plexEnabledKey}>
        <Section header="Host">
            ...
            <Number label="Port" settingKey="settings-plex-port" defaultValue={32400}></Number>
        ...
        <Section header="Movie editing">
            <Text label="Name of the library" settingKey="settings-plex-movie_library"></Text>
            <Check label="Set the movie as recently added after downloading the subtitles" settingKey="settings-plex-set_added"></Check>
        </Section>
      </CollapseBox>
    </Layout>
  );
