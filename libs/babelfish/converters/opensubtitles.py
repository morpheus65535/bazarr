...
class OpenSubtitlesConverter(LanguageReverseConverter):
    def __init__(self):
        ...
        self.to_opensubtitles = {('por', 'BR'): 'pob',  ('chi', None, 'Hant'): 'zht', ('gre', None): 'ell', ('srp', None): 'scc', ('srp', 'ME'): 'mne'}
        self.from_opensubtitles = CaseInsensitiveDict({'pob': ('por', 'BR'), 'zht': ('zho', None ,'Hant'), 'pb': ('por', 'BR'), 'ell': ('ell', None),
